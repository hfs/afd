...
main(int argc, char *argv[])
{
   ...
   char        *p_end = NULL,
               ...
               mon_sys_log_fifo[MAX_PATH_LENGTH];
   FILE        *p_log_file;
...
#ifdef _FIFO_DEBUG
      log_stat = logger(p_log_file, mon_sys_log_fd, "system_log",
                        MON_SYS_LOG_RESCAN_TIME);
#else
      log_stat = logger(p_log_file, mon_sys_log_fd,  MON_SYS_LOG_RESCAN_TIME);
#endif
