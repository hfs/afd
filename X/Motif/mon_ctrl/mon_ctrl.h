...
#define ACTIVE_TRANSFER_STEP_SIZE      20    /* The number of active     */
                                             /* transfers after which a  */
                                             /* new bar is started with  */
                                             /* a new color.             */
...
#define MON_TRANS_W                    2
#define MON_INPUT_W                    3
#define MON_OUTPUT_W                   4
#define MON_DELETE_W                   5
#define MON_VIEW_LOAD_W                6
