   ...
   do
   {
      ...
      if (qfl[lines_displayed].queue_type == SHOW_INPUT)
      {
         *p_type = 'I';
           ...
           {
              *p_type = 'O';
              if (qfl[lines_displayed].in_error_dir == YES)
              {
                 *(p_type + 1) = 'E';
                 if (qfl[lines_displayed].msg_name[0] != '\0')
                 {
                    *(p_type + 2) = qfl[lines_displayed].msg_name[0];
                 }
              }
              else
              {
                 if (qfl[lines_displayed].msg_name[0] != '\0')
                 {
                    *(p_type + 1) = qfl[lines_displayed].msg_name[0];
                 }
              }
           }
              ...
              *(p_type + 1) = 'U';
              if (qfl[lines_displayed].in_error_dir == YES)
              {
                 *(p_type + 2) = 'E';
                 if (qfl[lines_displayed].msg_name[0] != '\0')
                 {
                    *(p_type + 3) = qfl[lines_displayed].msg_name[0];
                 }
              }
              else
              {
