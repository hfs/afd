...
main(int argc, char *argv[])
{
   char            window_title[100],
                   ...
                   *toggle_label[] = {"AGE(O)", "AGE(I)", "USER", "OTHER"},
...
/*                           Toggle Box                                  */
/*                           ----------                                  */
/* Let user select the deletion type: AGE(I/O), USER and/or OTHER.       */
/* Default is AGE(O), AGE(I), USER and OTHER.                            */
/*-----------------------------------------------------------------------*/
   ...
   toggles_set = SHOW_AGE_OUTPUT | SHOW_AGE_INPUT | SHOW_USER_DEL |
                 SHOW_OTHER_DEL;
