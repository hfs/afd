...
/*
 ** NAME
 **   calc_next_time - calculates next time when job is to be
 **                    distributed
 **
 ** SYNOPSIS
 ...
 **
 ** DESCRIPTION
 **   The function calc_next_time() calculates the next time from the
 **   current_time and from the structure bd_time_entry te.
 **
 ** RETURN VALUES
 **   On success a value greater then zero is returned.
 **
 ** BUGS
