...
#ifdef WITH_INOTIFY
# define INOTIFY_RENAME            8192
# define INOTIFY_CLOSE             16384
/*
...
#endif
                    *map_file(char *, int *, struct stat *, int, ...),
