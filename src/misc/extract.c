...
#else
                        additional_offset += sprintf(&p_file_name[file_name_offset + end_offset],
#endif
                                                     "#%s.%s#%s#%s#%s#%s",
...
#else
                        additional_offset += sprintf(&p_file_name[file_name_offset + end_offset + additional_offset],
#endif
                                                     "-%x",
